...
//! Standard Blowfish P-array and S-box constants.
//!
//! These are the hexadecimal digits of pi, as defined in the original
//! Blowfish specification by Bruce Schneier.
